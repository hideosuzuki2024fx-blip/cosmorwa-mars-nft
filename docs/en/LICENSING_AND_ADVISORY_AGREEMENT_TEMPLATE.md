...
## 2. Purpose
Define a limited license for the Mars Reference Grid materials and optional advisory services, focused on mission enablement.
...
## 6. Term
Initial term of [TBD] with renewal options.

## 7. Termination
Termination for convenience with notice, and for cause upon material breach.

## 8. Payment Options (Non-binding)
Option A: **Buyout** — one-time fee for perpetual license rights (if requested).

Option B: **Advisory Retainer** — periodic retainer for limited advisory hours.

Option C: **Capped Performance-Based** — success fee or royalty with a defined cap.

Option D: **Non-cash Benefits** — research access, co-authorship, or in-kind support.

## 9. Reporting and Audit
If performance-based terms are selected, reporting and audit rights are defined here.
...
Parties agree to comply with applicable law and export controls.
